...
const Profile = () => {
  ...
  const SocialMedia = (
    <>
      <AiFillFacebook onClick={() => newTabSocial("https://www.facebook.com/felp.montenegro")} />
      <AiFillInstagram onClick={() => newTabSocial("https://instagram.com/felp88")} />
      <AiFillYoutube onClick={() => newTabSocial("https://youtube.com")} />
      <AiFillLinkedin onClick={() => newTabSocial("https://www.linkedin.com/in/felipe-montenegro-ribeiro/")} />
      <AiOutlineTwitter onClick={() => newTabSocial("https://twitter.com")} />
      <AiFillGithub onClick={() => newTabSocial("https://gitlab.com/felipe.mribeiro")} />
  ...
  return (
    <LayoutBase breadcrumb={BreadCrumb} title="Perfil" actions={Actions}>
      <SliceTop>
        ...
        <div className="title">Felipe Montenegro</div>
        <div className="subTitle">Web Developer Full Stack</div>
      ...
      <SliceMiddle>
        <div className="description">
          ...
          Me chamo Felipe Montenegro Ribeiro, tenho 32 anos, moro na Tijuca, Rio de janeiro.
